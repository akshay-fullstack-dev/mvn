...
class BookPackage extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'payment_details.total_amount' => 'required|numeric|gte:0',
            'payment_details.currency_code' => 'required|string',
            'payment_details.total_amount_paid' => 'required|numeric',
            'payment_details.via_wallet' => 'required|numeric|max:25|gte:0',
    ...
    public function messages()
    {
        return [
            ...
            'booking_details.*.time.date_format' => $this->getMessage('date_format', ['attribute' => 'booking time', 'format' => 'H:i']),
            ...
            'payment_details.via_wallet.gte'=> $this->getMessage('gte', ['attribute' => 'wallet amount']),
            'payment_details.total_amount.gte'=> $this->getMessage('gte', ['attribute' => 'payment total amount']),
        ];
    }
}
