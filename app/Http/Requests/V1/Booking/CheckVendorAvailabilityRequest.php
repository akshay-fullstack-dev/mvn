...
class CheckVendorAvailabilityRequest extends FormRequest
{
    use APIRequest;
    use LangTrait;
    ...
    public function rules()
    {
        return [
            ...
            'payment_details.card_id' => 'nullable|string|max:50',
            ...
            'payment_details.via_wallet' => 'required|numeric',
    ...
    public function messages()
    {
        return [
            ...
            'payment_details.total_amount.numeric' => $this->getMessage('required', ['attribute' => 'payment total amount']),
