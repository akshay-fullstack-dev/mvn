...
class FillPermissionsForPackageMaintain extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPackageMaintain constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.package-maintain',
            'admin.package-maintain.index',
            'admin.package-maintain.create',
            'admin.package-maintain.show',
            'admin.package-maintain.edit',
            'admin.package-maintain.delete',
            'admin.package-maintain.bulk-delete',
        ]);
