...
class FillPermissionsForAppVersion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAppVersion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.app-version',
            'admin.app-version.index',
            'admin.app-version.create',
            'admin.app-version.show',
            'admin.app-version.edit',
            'admin.app-version.delete',
            'admin.app-version.bulk-delete',
        ]);
