...
class FillPermissionsForDeliveryCharge extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDeliveryCharge constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.delivery-charge.show',
            'admin.delivery-charge.edit',
            'admin.delivery-charge.delete',
            'admin.delivery-charge.bulk-delete',
        ]);
