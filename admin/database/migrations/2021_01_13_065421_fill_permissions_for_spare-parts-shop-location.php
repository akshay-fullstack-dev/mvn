...
class FillPermissionsForSparePartsShopLocation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSparePartsShopLocation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.spare-parts-shop-location',
            'admin.spare-parts-shop-location.index',
            'admin.spare-parts-shop-location.create',
            'admin.spare-parts-shop-location.show',
            'admin.spare-parts-shop-location.edit',
            'admin.spare-parts-shop-location.delete',
            'admin.spare-parts-shop-location.bulk-delete',
        ]);
