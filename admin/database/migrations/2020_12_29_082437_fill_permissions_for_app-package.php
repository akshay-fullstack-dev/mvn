...
class FillPermissionsForAppPackage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAppPackage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.app-package',
            'admin.app-package.index',
            'admin.app-package.create',
            'admin.app-package.show',
            'admin.app-package.edit',
            'admin.app-package.delete',
            'admin.app-package.bulk-delete',
        ]);
