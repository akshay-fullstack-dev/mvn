...
class FillPermissionsForVendorRequestedService extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVendorRequestedService constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.vendor-requested-service',
            'admin.vendor-requested-service.index',
            'admin.vendor-requested-service.create',
            'admin.vendor-requested-service.show',
            'admin.vendor-requested-service.edit',
            'admin.vendor-requested-service.delete',
            'admin.vendor-requested-service.bulk-delete',
        ]);
