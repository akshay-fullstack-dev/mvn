...
class FillPermissionsForDispute extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDispute constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.dispute',
            'admin.dispute.index',
            'admin.dispute.create',
            'admin.dispute.show',
            'admin.dispute.edit',
            'admin.dispute.delete',
            'admin.dispute.bulk-delete',
        ]);
