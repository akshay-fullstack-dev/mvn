...
class FillPermissionsForReferralAmount extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForReferralAmount constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.referral-amount',
            'admin.referral-amount.index',
            'admin.referral-amount.create',
            'admin.referral-amount.show',
            'admin.referral-amount.edit',
            'admin.referral-amount.delete',
            'admin.referral-amount.bulk-delete',
        ]);
