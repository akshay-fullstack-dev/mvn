...
class BookingEnum
{
    ...
    const BOOKING_CANCEL_CRONE_TIME_IN_MINUTES = 60;

    //reschedule minimum difference between booking time and reschedule time
    const RescheduleMinimumTimeInHours = 2;

    //because of package we dont getting service_id and vendor_id from android cause we use enum .

    const ServiceIdForPackage = 0;
    const VendorIdForPackage = 0;
