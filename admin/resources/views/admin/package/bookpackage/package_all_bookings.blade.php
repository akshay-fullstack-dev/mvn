                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'user_id'">
                                            {{ trans('admin.booking.columns.user_id') }}
                                        </th>
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in collection" :key="item.id"
                                        ...
                                        <td>
                                            <span
                                                v-if="item . booking_type==0">{{ trans('booking.normal_booking') }}</span>
                                            ...
                                            <div class="row no-gutters">
                                                <div class="col-auto">
                                                    <a class="btn btn-sm btn-spinner btn-info"
                                                        :href="item.resource_url + '/view'" title="{{ trans('View') }}"
